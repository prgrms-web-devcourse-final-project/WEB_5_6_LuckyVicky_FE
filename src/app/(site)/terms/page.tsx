...
export default function TermsPage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-bold mb-5">이용약관</h1>
      <span className='font-bold'>모리모리 서비스 이용약관</span>

      <section className="mb-8 mt-5 text-sm">
        <h2 className="mb-2">제1조 (목적)</h2>
        <p className='mb-8'>
          이 약관은 모리모리 회사(전자상거래 사업자)가 운영하는 모리모리 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
        <p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
      </section>

      <section className="mb-8 text-sm">
        <h2 className="mb-2">제2조 (정의)</h2>
        <ol className="list-decimal ml-6 space-y-2">
          <li>
            “몰” 이란 모리모리 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
          </li>
          <li>
      ...
      <section className="mb-8 text-sm">
        <h2 className="mb-2">제3조 (약관등의 명시와 설명 및 개정)</h2>
        <ol className="list-decimal ml-6 space-y-2">
          <li>
      ...
      <section className="mb-8 text-sm">
        <h2 className="mb-2">제4조(서비스의 제공 및 변경)</h2>
        <ol className="list-decimal ml-6 space-y-2">
          <li>
      ...
      <section className="mb-8 text-sm">
        <h2 className="mb-2">제5조(서비스의 중단)</h2>
        <ol className="list-decimal ml-6 space-y-2">
          <li>
  ...
  <ol className="list-decimal ml-6 space-y-2">
    ...
    <li>
      회원은 제15조제1항에 의한 등록사항에 변경이 있는 경우, 즉시 전자우편 기타
      방법으로 “몰”에 대하여 그 변경사항을 알려야 합니다.
    </li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제7조(회원 탈퇴 및 자격 상실 등)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    ...
    <li>
      ...
      <ol className="list-decimal ml-6 mt-2 space-y-1">
        ...
        <li>
          “몰”을 이용하여 구입한 재화등의 대금, 기타 “몰”이용에 관련하여 회원이
    ...
    <li>
      “몰”이 회원 자격을 제한/정지 시킨후, 동일한 행위가 2회 이상 반복되거나 30일
      이내에 그 사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.
    </li>
    <li>
      “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게
      이를 통지하고, 회원등록 말소전에 최소한 30일 이상의 기간을 정하여 소명할
      기회를 부여합니다.
    </li>
  </ol>
</section>
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제9조(구매신청)</h2>
  <p className="mb-2">
    “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며,
    “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제10조 (계약의 성립)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>
      “몰”은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수
      있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제11조(지급방법)</h2>
  <p className="mb-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의2조(캐시 및 지갑의 정의)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>“캐시”라 함은 “몰”에서 재화 등을 구매하기 위하여 회원이 충전하거나 “몰”이 부여하는 서비스 전용 선불수단을 말합니다.</li>
    <li>“보너스 캐시”라 함은 이벤트·프로모션·보상 등으로 무상 부여되는 캐시를 말하며 현금환급 대상이 아닙니다. MVP 기간 동안에는 제공되지 않습니다.</li>
    <li>“현금성 캐시”라 함은 회원이 유상으로 충전한 캐시를 말합니다. 현금환급 기능은 제공하지 않습니다.</li>
    <li>“작가지갑(정산캐시)”라 함은 판매대금 정산을 위해 작가회원에게 적립되는 지갑을 말합니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의3조(캐시의 충전·사용·차감 순서)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>회원은 “몰”이 정한 방법(각종 페이 등)으로 캐시를 충전할 수 있습니다.</li>
    <li>캐시 사용 시 차감 순서는 보너스 캐시 → 현금성 캐시 순으로 합니다(별도 고지 시 달리 정할 수 있음).</li>
    <li>캐시는 “몰” 내 재화·용역 결제에 한하여 사용할 수 있으며, 타인에게 양도·대여·담보 제공할 수 없습니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의4조(캐시의 환급·소멸)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>회원은 캐시를 현금으로 환급받을 수 없습니다.</li>
    <li>회원이 계정을 탈퇴하는 경우 보유 캐시는 전액 소멸합니다. (소멸 예정 금액은 탈퇴 화면에 고지합니다.)</li>
    <li>캐시 충전 후 결제취소·환불이 발생하는 때에는 결제 취소 범위 내에서 캐시로 재적립하거나, 최초 결제수단으로의 환불 등 “몰”이 정한 기준에 따릅니다.</li>
    <li>“몰”은 장기간 미이용 계정의 캐시 소멸 기준(예: 최종 사용일로부터 12개월)을 서비스 화면에 사전 고지할 수 있습니다. 보너스 캐시는 부여 시 고지된 유효기간 경과 시 자동 소멸됩니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의5조(오류 정정 및 제한)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>시스템 오류, 결제사 취소·차지백, 부정 사용 등이 발생한 경우 “몰”은 해당 금액을 <strong>정정(가감)</strong>할 수 있으며, 필요한 경우 일시적으로 캐시 사용을 제한할 수 있습니다.</li>
    <li>회원의 귀책 사유로 인한 부정 충전·부정 사용이 확인되면 “몰”은 캐시 회수, 거래 취소, 회원자격 제한 등 필요한 조치를 할 수 있습니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의6조(작가지갑(정산캐시))</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>작가회원의 판매대금은 정산 주기(예: 매월/매주) 및 검수·환불 보류 기간 경과 후 작가지갑에 적립됩니다.</li>
    <li>작가회원은 본인 확인(KYC) 및 세무 정보 등록 후 “몰”이 정한 절차에 따라 현금 출금을 신청할 수 있습니다. 출금 수수료·최소/최대 한도는 화면에 고지합니다.</li>
    <li>정산 대상 금액은 판매금액에서 수수료, PG 수수료, 환불·차지백·분쟁 보류액 등을 차감한 금액으로 산정합니다. 보류액은 사유 해소 시점에 정산됩니다.</li>
    <li>허위 등록·저작권 침해 등으로 거래가 취소되는 경우, 이미 지급된 금액은 상계 또는 환수될 수 있습니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의7조(탈퇴 및 계정 정지 시 처리)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>회원이 탈퇴를 신청하는 경우, 미해결 주문·분쟁·환불이 있는 때에는 해당 사유가 해소될 때까지 탈퇴가 보류될 수 있습니다.</li>
    <li>탈퇴가 확정되면 제11의4조에 따라 캐시는 소멸되고, 개인정보는 법령 및 개인정보처리방침에 따라 파기 또는 분리보관합니다.</li>
    <li>작가회원의 경우, 미정산 금액은 본인 확인 완료 및 보류 사유 해소 후 출금 절차에 따릅니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제11의8조(약관 우선·변경 고지)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>캐시·작가지갑 운영정책의 세부 사항(충전/사용/수수료/한도/유효기간 등)은 서비스 화면의 운영정책으로 정할 수 있으며, 본 약관과 상충하는 경우 본 약관을 우선합니다.</li>
    <li>“몰”은 캐시·작가지갑 정책을 변경하는 때에는 적용일자 및 주요 변경 내용을 7일(이용자에게 불리한 경우 30일) 이전에 공지합니다.</li>
  </ol>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제12조(수신확인통지/구매신청 변경 및 취소)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제13조(재화등의 공급)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제14조(환급)</h2>
  <p>
    “몰”은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수
    없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을
    받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한
    조치를 취합니다.
  </p>
</section>

<section className="mb-8 text-sm">
  <h2 className="mb-2">제15조(청약철회 등)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제16조(청약철회 등의 효과)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>
      “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은
      재화등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화등의 환급을
    ...
    <li>
      ...
      부담합니다. “몰”은 이용자에게 청약철회등을 이유로 위약금 또는 손해배상을
      청구하지 않습니다. 다만 재화등의 내용이 표시·광고 내용과 다르거나
      계약내용과 다르게 이행되어 청약철회등을 하는 경우 재화등의 반환에 필요한
      비용은 “몰”이 부담합니다.
    </li>
    <li>
      이용자가 재화등을 제공받을 때 발송비를 부담한 경우에 “몰”은 청약철회 시
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제17조(개인정보보호)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>
      “몰”은 이용자의 정보수집시 구매계약 이행에 필요한 최소한의 정보를
      수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.
      <ol className="list-decimal ml-6 mt-2 space-y-1">
        <li>성명</li>
        <li>주소</li>
        <li>전화번호</li>
    ...
    <li>
      제공된 개인정보는 당해 이용자의 동의없이 목적외의 이용이나 제3자에게 제공할
      수 없으며, 이에 대한 모든 책임은 “몰”이 집니다. 다만, 다음의 경우에는
      예외로 합니다.
      <ol className="list-decimal ml-6 mt-2 space-y-1">
    ...
    <li>
      ...
      신용카드, 은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 변조
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제18조(“몰“의 의무)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제19조(회원의 ID 및 비밀번호에 대한 의무)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제20조(이용자의 의무)</h2>
  <ol className="list-decimal ml-6 space-y-1">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제21조(연결“몰”과 피연결“몰” 간의 관계)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>
      상위 “몰”과 하위 “몰”이 하이퍼 링크(예: 하이퍼 링크의 대상에는 문자, 그림
      및 동화상 등이 포함됨) 방식 등으로 연결된 경우, 전자를 연결 “몰”(웹
      사이트)이라고 하고 후자를 피연결 “몰”(웹사이트)이라고 합니다.
    </li>
    <li>
      연결“몰”은 피연결“몰”이 독자적으로 제공하는 재화등에 의하여 이용자와
      행하는 거래에 대해서 보증책임을 지지 않는다는 뜻을 연결“몰”의 초기화면 또는
      연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증책임을 지지
      않습니다.
    </li>
  </ol>
</section>
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제22조(저작권의 귀속 및 이용제한)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제23조(분쟁해결)</h2>
  <ol className="list-decimal ml-6 space-y-2">
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">제24조(재판권 및 준거법)</h2>
  <ol className="list-decimal ml-6 space-y-2">
    <li>
...
<section className="mb-8 text-sm">
  <h2 className="mb-2">부 칙(시행일)</h2>
  <p>이 약관은 2025년 9월 20일부터 시행합니다.</p>
</section>
